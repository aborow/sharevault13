...
class MergePartnerAutomatic(models.TransientModel):
    ...
    group_by_domain = fields.Boolean('domain')

    # Override Method for add groupBy domain as per Ticket SV-170
    @api.model
    def _generate_query(self, fields, maximum_group=100):
        ...
        filters = []
        for field in fields:
            if field in ['email', 'name', 'vat', 'domain']:
